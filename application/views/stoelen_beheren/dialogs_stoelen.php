            ...
            buttons: {
                "OK": function() {
                    if (validatieOK()) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: site_url + "/admin/update_stoel",
                            async: false,
                            data: dataString,
                            dataType: "json"
                        });
        ...
        $("#dialog-delete").dialog({
            ...
            buttons: {
                "Ja": function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: site_url + "/admin/delete_stoel",
                        async: false,
                        data: {id: deleteid},
                        success: function(result) {
                            if (result == '0') {
...
<div id="dialog-detail" title="Stoel beheren">
    <form id="JqAjaxForm">
...
<div id="dialog-delete" title="Bevestiging">
    <p><span style="float:left; margin:0 20px 20px 0;"><img src="<?php echo base_url() . APPPATH; ?>images/icons/delete.png" /></span>
        <span>De stoel wordt verwijderd. Ben je zeker?</span>
    </p>
</div>

<div id="dialog-delete-fout" title="Fout">
    <p><span style="float:left; margin:0 20px 20px 0;"><img src="<?php echo base_url() . APPPATH; ?>images/icons/delete.png" /></span>
        <span>Je kan deze stoel niet verwijderen.</span>
    </p>
</div>
